...
#
# Generated by export_simulation on Wed Apr 27 12:29:05 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './SimpleCPU01Design.sh' script.

./SimpleCPU01Design.sh -reset_run
...
./SimpleCPU01Design.sh -noclean_files

For more information on the script, please type './SimpleCPU01Design.sh -help'.
