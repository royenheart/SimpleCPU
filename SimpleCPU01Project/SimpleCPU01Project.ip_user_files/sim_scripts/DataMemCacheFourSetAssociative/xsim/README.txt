...
#
# Generated by export_simulation on Fri May 27 21:41:44 +0800 2022
#
################################################################################
...
./DataMemCacheFourSetAssociative.sh
...
'-reset_run' switch to the './DataMemCacheFourSetAssociative.sh' script.

./DataMemCacheFourSetAssociative.sh -reset_run
...
./DataMemCacheFourSetAssociative.sh -noclean_files

For more information on the script, please type './DataMemCacheFourSetAssociative.sh -help'.
