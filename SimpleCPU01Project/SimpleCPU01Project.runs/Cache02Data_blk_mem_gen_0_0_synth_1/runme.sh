...
HD_PWD='D:/Git/SimpleCPU/SimpleCPU01Project/SimpleCPU01Project.runs/Cache02Data_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cache02Data_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cache02Data_blk_mem_gen_0_0.tcl
