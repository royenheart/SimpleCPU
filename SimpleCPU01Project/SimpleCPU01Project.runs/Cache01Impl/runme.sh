...
HD_PWD='D:/Git/SimpleCPU/SimpleCPU01Project/SimpleCPU01Project.runs/Cache01Impl'
cd "$HD_PWD"
...
EAStep vivado -log DataMemFourSetCache01.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DataMemFourSetCache01.tcl -notrace
