...
HD_PWD='D:/Git/SimpleCPU/SimpleCPU01Project/SimpleCPU01Project.runs/Cache02Impl'
cd "$HD_PWD"
...
EAStep vivado -log Cache02Data_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Cache02Data_wrapper.tcl -notrace
