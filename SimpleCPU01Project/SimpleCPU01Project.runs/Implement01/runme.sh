...
HD_PWD='D:/Git/SimpleCPU01/SimpleCPU01Project/SimpleCPU01Project.runs/Implement01'
cd "$HD_PWD"
...
EAStep vivado -log Chip_InstrIP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Chip_InstrIP.tcl -notrace
