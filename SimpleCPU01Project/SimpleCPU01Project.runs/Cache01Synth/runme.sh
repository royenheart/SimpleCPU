...
HD_PWD='D:/Git/SimpleCPU/SimpleCPU01Project/SimpleCPU01Project.runs/Cache01Synth'
cd "$HD_PWD"
...
EAStep vivado -log DataMemFourSetCache01.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataMemFourSetCache01.tcl
