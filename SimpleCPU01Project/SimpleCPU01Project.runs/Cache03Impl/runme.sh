...
HD_PWD='D:/Git/SimpleCPU/SimpleCPU01Project/SimpleCPU01Project.runs/Cache03Impl'
cd "$HD_PWD"
...
EAStep vivado -log DataMemDirectCache03.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DataMemDirectCache03.tcl -notrace
