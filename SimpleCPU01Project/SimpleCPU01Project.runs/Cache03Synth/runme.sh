...
HD_PWD='D:/Git/SimpleCPU/SimpleCPU01Project/SimpleCPU01Project.runs/Cache03Synth'
cd "$HD_PWD"
...
EAStep vivado -log DataMemDirectCache03.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataMemDirectCache03.tcl
