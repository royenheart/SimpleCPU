...
HD_PWD='D:/Git/SimpleCPU01/SimpleCPU01Project/SimpleCPU01Project.runs/Synthesis01'
cd "$HD_PWD"
...
EAStep vivado -log Chip_InstrIP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Chip_InstrIP.tcl
