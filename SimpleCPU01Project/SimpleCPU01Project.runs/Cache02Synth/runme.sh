...
HD_PWD='D:/Git/SimpleCPU/SimpleCPU01Project/SimpleCPU01Project.runs/Cache02Synth'
cd "$HD_PWD"
...
EAStep vivado -log Cache02Data_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cache02Data_wrapper.tcl
